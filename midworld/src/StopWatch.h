...
//@}
   ...
   /** get the time since timeStart().
    *  this returns timeCurrent() - timeStart()
    */
   double                timeRunning() const; 
 ...
 */
#ifndef WIN32
   inline double StopWatch::timeCurrent()
   {
     struct timeval tv;
     gettimeofday( &tv, 0 );
...
{
   mTimeStarted = StopWatch::timeCurrent();
}
...
{
   mTimeStopped = StopWatch::timeCurrent();
 ...
 *  this returns timeCurrent() - timeStart()
 */
inline double StopWatch::timeRunning() const
{ 
