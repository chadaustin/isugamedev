 ...
 *
 ********************************************************** midworld-cpr-end */
#ifndef MW_BOUNDS_SWEEP_COLLISION_DETECTOR_H
#define MW_BOUNDS_SWEEP_COLLISION_DETECTOR_H
...
namespace mw
{
    ...
    * @ingroup CollDet
    *
    * This implementation of the CollisionDetector interface uses an AABox sweep
    * test to ensure temporally coherant collision detection.
    */
   class BoundsSweepCollisionDetector : public CollisionDetector
   {
   public:
