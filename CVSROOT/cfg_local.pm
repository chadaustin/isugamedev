...
$MAILADDRS = 'subatomic@users.sourceforge.net';
#$MAILADDRS = 'isugamedev-checkins@lists.sourceforge.net';

@COMMIT_HOSTS = ();

$MAIL_TRANSFORM = sub {
   add_viewcvs_entry("http://cvs.sourceforge.net/cgi-bin/viewcvs.cgi/isugamedev",
                     '', @_);
};
