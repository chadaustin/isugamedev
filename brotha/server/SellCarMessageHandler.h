 ...
 *
 * -----------------------------------------------------------------
 * File:          $RCSfile: SellCarMessageHandler.h,v $
...
#ifndef SELL_CAR_MESSAGE_HANDLER_H
#define SELL_CAR_MESSAGE_HANDLER_H

#include "MessageHandler.h"

namespace server {
   class SellCarMessageHandler : public MessageHandler {
   public:
      SellCarMessageHandler(BrothaGame* game, net::NetMgr* netMgr)
         : MessageHandler(game, netMgr) {
      }

      ~SellCarMessageHandler() {}

      virtual void handleMessage(net::Message *msg, net::NetMgr::ConnID cID) {
         net::SellCarMessage *mMsg = (net::SellCarMessage*)msg;
...
#endif // SELL_CAR_MESSAGE_HANDLER_H
