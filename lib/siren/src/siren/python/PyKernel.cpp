...
{
   // Kernel
   class_<Kernel, KernelPtr>("Kernel")
      .def("start", &Kernel::start)
      .def("transitionTo", &Kernel::transitionTo)
      .add_property("width", &Kernel::getWidth)
      .add_property("height", &Kernel::getHeight)
   ;
}
