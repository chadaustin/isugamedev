...
/* @(#) $Id: deflate.h,v 1.1.1.1 2002-01-17 00:05:01 subatomic Exp $ */
...
typedef struct internal_state {
    ...
    unsigned char  data_type;     /* UNKNOWN, BINARY or ASCII */
    unsigned char  method;        /* STORED (for zip only) or DEFLATED */
...
/* Inline versions of _tr_tally for speed: */
  ...
  extern unsigned char _length_code[];
